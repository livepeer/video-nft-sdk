...
export default function handler(
  ...
  res.status(200).json({
    ...
    description: `\
Long Take NFTs are video NFTs up to 10GB in size that are transcoded on the Livepeer network for optimal video playback for viewers on any device or bandwidth.
`,
